...
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my1p.dns.podman --execute \
    "CREATE USER IF NOT EXISTS 'repl'@'%' IDENTIFIED WITH mysql_native_password BY 'repl'"
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my2p.dns.podman --execute \
    "CREATE USER IF NOT EXISTS 'repl'@'%' IDENTIFIED WITH mysql_native_password BY 'repl'"
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my3p.dns.podman --execute \
    "CREATE USER IF NOT EXISTS 'repl'@'%' IDENTIFIED WITH mysql_native_password BY 'repl'"
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my4p.dns.podman --execute \
    "CREATE USER IF NOT EXISTS 'repl'@'%' IDENTIFIED WITH mysql_native_password BY 'repl'"
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my5p.dns.podman --execute \
    "CREATE USER IF NOT EXISTS 'repl'@'%' IDENTIFIED WITH mysql_native_password BY 'repl'"

echo mysql: grant repl user replication permission
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my1p.dns.podman --execute "GRANT REPLICATION SLAVE ON *.* TO 'repl'@'%'"
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my2p.dns.podman --execute "GRANT REPLICATION SLAVE ON *.* TO 'repl'@'%'"
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my3p.dns.podman --execute "GRANT REPLICATION SLAVE ON *.* TO 'repl'@'%'"
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my4p.dns.podman --execute "GRANT REPLICATION SLAVE ON *.* TO 'repl'@'%'"
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my5p.dns.podman --execute "GRANT REPLICATION SLAVE ON *.* TO 'repl'@'%'"

echo mysql: flush privileges
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my1p.dns.podman --execute 'FLUSH PRIVILEGES'
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my2p.dns.podman --execute 'FLUSH PRIVILEGES'
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my3p.dns.podman --execute 'FLUSH PRIVILEGES'
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my4p.dns.podman --execute 'FLUSH PRIVILEGES'
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my5p.dns.podman --execute 'FLUSH PRIVILEGES'
...
position=$(
    podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my5p --execute 'SHOW MASTER STATUS\G' | sed -e '/^ *Position:/!d' -e 's/[^0-9]*//g'
)
...
position=$(
    podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my1p --execute 'SHOW MASTER STATUS\G' | sed -e '/^ *Position:/!d' -e 's/[^0-9]*//g'
)
...
MASTER_PASSWORD='repl',MASTER_LOG_FILE='mysql-bin.000003',MASTER_LOG_POS=$position"
position=$(
    podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my2p --execute 'SHOW MASTER STATUS\G' | sed -e '/^ *Position:/!d' -e 's/[^0-9]*//g'
)
...
MASTER_PASSWORD='repl',MASTER_LOG_FILE='mysql-bin.000003',MASTER_LOG_POS=$position"
position=$(
    podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my3p --execute 'SHOW MASTER STATUS\G' | sed -e '/^ *Position:/!d' -e 's/[^0-9]*//g'
)
...
MASTER_PASSWORD='repl',MASTER_LOG_FILE='mysql-bin.000003',MASTER_LOG_POS=$position"
position=$(
    podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my4p --execute 'SHOW MASTER STATUS\G' | sed -e '/^ *Position:/!d' -e 's/[^0-9]*//g'
)
