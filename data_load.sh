...
podman exec --env=MYSQL_PWD=rootpass my1c mysql --user=root --host=my1c --execute 'SOURCE /data/all_import.sql\G'
...
podman exec --env=MYSQL_PWD=rootpass my1c mysql --user=root --host=my1p --execute 'RESET SLAVE ALL\G'
podman exec --env=MYSQL_PWD=rootpass my1c mysql --user=root --host=my2p --execute 'RESET SLAVE ALL\G'
podman exec --env=MYSQL_PWD=rootpass my1c mysql --user=root --host=my3p --execute 'RESET SLAVE ALL\G'
podman exec --env=MYSQL_PWD=rootpass my1c mysql --user=root --host=my4p --execute 'RESET SLAVE ALL\G'
podman exec --env=MYSQL_PWD=rootpass my1c mysql --user=root --host=my5p --execute 'RESET SLAVE ALL\G'
podman exec --env=MYSQL_PWD=rootpass my1c mysql --user=root --host=my1p --execute 'SHOW MASTER STATUS\G'
podman exec --env=MYSQL_PWD=rootpass my1c mysql --user=root --host=my2p --execute 'SHOW MASTER STATUS\G'
podman exec --env=MYSQL_PWD=rootpass my1c mysql --user=root --host=my3p --execute 'SHOW MASTER STATUS\G'
podman exec --env=MYSQL_PWD=rootpass my1c mysql --user=root --host=my4p --execute 'SHOW MASTER STATUS\G'
