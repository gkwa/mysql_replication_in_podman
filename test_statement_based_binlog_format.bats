...
result=$(podman exec --env=MYSQL_PWD=rootpass my1c mysql --host=my1p --execute 'SHOW VARIABLES LIKE "binlog_format"')
run grep --silent -E 'binlog_format.*STATEMENT' <<<"$result"
[ "$status" -eq 0 ]

result=$(podman exec --env=MYSQL_PWD=rootpass my1c mysql --host=my2p --execute 'SHOW VARIABLES LIKE "binlog_format"')
run grep --silent -E 'binlog_format.*STATEMENT' <<<"$result"
[ "$status" -eq 0 ]

result=$(podman exec --env=MYSQL_PWD=rootpass my1c mysql --host=my3p --execute 'SHOW VARIABLES LIKE "binlog_format"')
run grep --silent -E 'binlog_format.*STATEMENT' <<<"$result"
[ "$status" -eq 0 ]

result=$(podman exec --env=MYSQL_PWD=rootpass my1c mysql --host=my4p --execute 'SHOW VARIABLES LIKE "binlog_format"')
run grep --silent -E 'binlog_format.*STATEMENT' <<<"$result"
[ "$status" -eq 0 ]

result=$(podman exec --env=MYSQL_PWD=rootpass my1c mysql --host=my5p --execute 'SHOW VARIABLES LIKE "binlog_format"')
run grep --silent -E 'binlog_format.*STATEMENT' <<<"$result"
[ "$status" -eq 0 ]
