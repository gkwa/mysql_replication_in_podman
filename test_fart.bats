...
podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my1p --execute 'DROP DATABASE IF EXISTS ptest'
...
run podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my2p.dns.podman --execute 'USE ptest'
[ "$status" == 1 ]
run podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my3p.dns.podman --execute 'USE ptest'
[ "$status" == 1 ]
run podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my4p.dns.podman --execute 'USE ptest'
[ "$status" == 1 ]
run podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my5p.dns.podman --execute 'USE ptest'
[ "$status" == 1 ]
...
run podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my1p.dns.podman --execute 'USE ptest'
[ "$status" == 0 ]
run podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my2p.dns.podman --execute 'USE ptest'
[ "$status" == 0 ]
run podman exec --env=MYSQL_PWD=root my1c mysql --skip-column-names --user=root --host=my3p.dns.podman --execute 'USE ptest'
