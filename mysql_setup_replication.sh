...
source_ip=$(podman inspect my1c --format '{{.NetworkSettings.Networks.replication.IPAddress}}'); podman exec --tty --interactive my1c mysql --user=root --password=root --host=my2p --execute "CHANGE REPLICATION SOURCE TO SOURCE_HOST='"$source_ip"', SOURCE_USER='repl', SOURCE_PASSWORD='repl', SOURCE_LOG_FILE='mysql-bin.000003', SOURCE_LOG_POS=2856;"
source_ip=$(podman inspect my2c --format '{{.NetworkSettings.Networks.replication.IPAddress}}'); podman exec --tty --interactive my2c mysql --user=root --password=root --host=my3p --execute "CHANGE REPLICATION SOURCE TO SOURCE_HOST='"$source_ip"', SOURCE_USER='repl', SOURCE_PASSWORD='repl', SOURCE_LOG_FILE='mysql-bin.000003', SOURCE_LOG_POS=2856;"
source_ip=$(podman inspect my3c --format '{{.NetworkSettings.Networks.replication.IPAddress}}'); podman exec --tty --interactive my3c mysql --user=root --password=root --host=my4p --execute "CHANGE REPLICATION SOURCE TO SOURCE_HOST='"$source_ip"', SOURCE_USER='repl', SOURCE_PASSWORD='repl', SOURCE_LOG_FILE='mysql-bin.000003', SOURCE_LOG_POS=2856;"
source_ip=$(podman inspect my4c --format '{{.NetworkSettings.Networks.replication.IPAddress}}'); podman exec --tty --interactive my4c mysql --user=root --password=root --host=my5p --execute "CHANGE REPLICATION SOURCE TO SOURCE_HOST='"$source_ip"', SOURCE_USER='repl', SOURCE_PASSWORD='repl', SOURCE_LOG_FILE='mysql-bin.000003', SOURCE_LOG_POS=2856;"
source_ip=$(podman inspect my5c --format '{{.NetworkSettings.Networks.replication.IPAddress}}'); podman exec --tty --interactive my5c mysql --user=root --password=root --host=my1p --execute "CHANGE REPLICATION SOURCE TO SOURCE_HOST='"$source_ip"', SOURCE_USER='repl', SOURCE_PASSWORD='repl', SOURCE_LOG_FILE='mysql-bin.000003', SOURCE_LOG_POS=2856;"
